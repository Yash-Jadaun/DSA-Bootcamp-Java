...
## Easy
- [Next greater element I](https://leetcode.com/problems/next-greater-element-i/) `leetcode`dn
- [Valid Parentheses](https://leetcode.com/problems/valid-parentheses/) `leetcode`dn
- [Min Stack](https://leetcode.com/problems/min-stack/) `leetcode`dn
...
- [Implement Queue using Stacks](https://leetcode.com/problems/implement-queue-using-stacks/) `leetcode`dn
## Medium
...
- [Asteroid Collision](https://leetcode.com/problems/asteroid-collision/) `leetcode`dn
- [132 Pattern](https://leetcode.com/problems/132-pattern/) `leetcode`dn
- [Design circular Queue](https://leetcode.com/problems/design-circular-queue/) `leetcode`
- [Find the Most Competitive Subsequence](https://leetcode.com/problems/find-the-most-competitive-subsequence/) `leetcode`dn
- [Design Front Middle Back Queue](https://leetcode.com/problems/design-front-middle-back-queue/) `leetcode`dn
- [Circular tour](https://practice.geeksforgeeks.org/problems/circular-tour/1) `GFG` `Amex` `Amazon`Dn
- [Task Scheduler](https://leetcode.com/problems/task-scheduler/) `leetcode`dn
